...
class MyTestCase(unittest.TestCase):
    def test_train_dataset(self):
        ...
        transform_params = {
            'resize_x': 200 // scrambler_params['parts_x'] * scrambler_params['parts_x'],
            'resize_y': 300 // scrambler_params['parts_y'] * scrambler_params['parts_y'],
        ...
        # --- Show images
        a = train_ds.get_item(15, for_display=True)
        original_image = a[0]
