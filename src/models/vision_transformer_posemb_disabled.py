...
"""
This is a copy of pytorch vision transformer, with one commented line that adds the pos. embedding to the x value.
Without it, the VIT should work without any spatial context of the patches it gets (equivalent to LLM working without word order in the sentence)
"""
...
class Encoder(nn.Module):
    ...
    def forward(self, input: torch.Tensor):
        torch._assert(input.dim() == 3, f"Expected (batch_size, seq_length, hidden_dim) got {input.shape}")
        # input = input + self.pos_embedding    #TODO:Yaniv: No positional embedding for patches
...
def vit_b_16_noemb(*, weights: Optional[ViT_B_16_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_b_32_noemb(*, weights: Optional[ViT_B_32_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_l_16_noemb(*, weights: Optional[ViT_L_16_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_l_32_noemb(*, weights: Optional[ViT_L_32_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_h_14_noemb(*, weights: Optional[ViT_H_14_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
