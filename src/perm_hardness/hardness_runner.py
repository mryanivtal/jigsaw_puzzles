...
from src.perm_hardness.mpe2d_flow import execute_mpe2d_flow
...
if __name__ == '__main__':
    ...
    default_test_config = Path(__file__).parent / Path('run_configs/mpe2d_params.json')
    ...
    execute_mpe2d_flow(run_params, project_path, train_data_path, test_data_path)
