...
from src.patch_adjacence_inference.patch_adjacence_infer_flow import execute_infer_flow
...
if __name__ == '__main__':
    ...
    # default_test_config = Path(__file__).parent / Path('run_configs/patch_adj_inference_10x10.json')
